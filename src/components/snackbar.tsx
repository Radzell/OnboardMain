...
const SnackBarProvider: React.FC<SnackBarContextProviderProps> = ({
  ...
  const [position, setPosition] = React.useState<SnackbarOrigin>({vertical: 'bottom', horizontal: 'center'});

  const showSnackBar = (text: string, color: AlertColor, position: SnackbarOrigin = 
